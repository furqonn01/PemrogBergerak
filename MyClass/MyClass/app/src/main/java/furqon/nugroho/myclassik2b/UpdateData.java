package furqon.nugroho.myclassik2b;
...
public class UpdateData extends AppCompatActivity {
        ...
        public void onClick(View arg0) {
                ...
                if(edit.isEmpty())
                    ...
                    db.execSQL("update biodata set nama='"+ text2.getText().toString() +"', tgl='" + text3.getText().toString()+"', jk='"+ text4.getText().toString() +"', alamat='" + text5.getText().toString() + "' where no='" + text1.getText().toString()+"'");Toast.makeText(getApplicationContext(), "Perubahan Tersimpan...", Toast.LENGTH_LONG).show();
                    finish();
                    }
