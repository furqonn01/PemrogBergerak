...
public class CardHpAdapter extends RecyclerView.Adapter<CardHpAdapter.ListViewHolder> {
    private ArrayList<Hp> listHmj;
    private Context context;
    public CardHpAdapter (Context context, ArrayList<Hp>listHmj){
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        final Hp hmj = listHmj.get(position);
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent detail=new Intent(context, DetaiListHp.class);
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            tvName=itemView.findViewById(R.id. name_list_hp);
